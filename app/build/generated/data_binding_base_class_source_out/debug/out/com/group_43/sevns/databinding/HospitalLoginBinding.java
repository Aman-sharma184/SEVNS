...
public final class HospitalLoginBinding implements ViewBinding {
  ...
  @NonNull
  public static HospitalLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HospitalLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.hospital_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HospitalLoginBinding bind(@NonNull View rootView) {
